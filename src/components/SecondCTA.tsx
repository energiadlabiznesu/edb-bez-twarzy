    ...
    <ScrollFadeIn>
      <div className="max-w-content mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 tracking-tight">
          <span className="line-through text-muted-foreground">5 000 zł</span> — dofinansowanie nawet do 100%
        </h2>
        <p className="text-muted-foreground text-base mb-4 leading-relaxed max-w-xl mx-auto">
          Dofinansowanie od państwa pokrywa nawet do 100% kosztów kursu. Program się kończy — sprawdź, czy jeszcze możesz skorzystać.
        </p>
