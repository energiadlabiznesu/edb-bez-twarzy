  ...
  <footer className="py-10 px-4 border-t border-border">
    <div className="max-w-content mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4 text-xs text-muted-foreground">
        ...
        <a href="https://energiabiznesu.pl/polityka-prywatnosci/" target="_blank" rel="noopener" className="hover:text-foreground transition-colors">Polityka prywatnosci</a>
      </div>
    </div>
  </footer>
);
