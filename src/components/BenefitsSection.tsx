...
const items = [
  ...
  { title: "Wideo i montaż", desc: "Tworzysz i montujesz wideo, budujesz awatary AI." },
  { title: "Kampanie reklamowe", desc: "Facebook Ads, Google Ads — od kreacji po uruchomienie." },
  { title: "Grafiki i treści", desc: "Posty, grafiki, teksty z ChatGPT i Canva. Bez grafika." },
  { title: "Automatyzacja", desc: "Mailingi, CRM, leady — automatyzacje oszczędzające godziny." },
  { title: "Agenci AI", desc: "Agenci AI odpowiadają klientom i kwalifikują leady za Ciebie." },
  { title: "20h warsztatów na żywo", desc: "Intensywny kurs online przez Zoom / Google Meet." },
  { title: "Praktyka, nie teoria", desc: "Pracujesz na swoich przykładach. Firmy, JDG, NGO." },
];
      ...
      <div className="max-w-content mx-auto">
        <ScrollFadeIn>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3 tracking-tight">
            Czego się nauczysz i jak wygląda kurs
          </h2>
          <p className="text-muted-foreground text-base mb-12 leading-relaxed max-w-2xl">
            20 godzin intensywnych warsztatów na żywo. Po kursie Twoja firma działa jak zespół z grafikiem, programistą i specjalistą od reklam — tylko że to wszystko robi AI.
          </p>
        </ScrollFadeIn>
